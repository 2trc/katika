...
def populate():
	...
	try:
		logger.info("Started populating the database with data ...")
		...
		logger.error(f"populating the database with data failed. Reason : {e}", e)
		logger.error("Transactions has been rolled back. Please, fix the error and try again.")
